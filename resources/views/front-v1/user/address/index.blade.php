        ...
        <div class="row bg-white">
            ...
            <div class="col-12  col-lg-8 py-4">{{--addresses--}}
                ...
                @else
                    <div class="row mt-5">
                        <div class="col-12 text-center">
                            <span class="font-weight-bolder alert-danger p-4 rounded">آدرسی برای ارسال سفارش وجود ندارد! لطفاً یک آدرس جدید ثبت کنید.</span>
                        </div>
                    </div>
                @endif
                ...
                <div class="row mt-5">{{--ADD NEW ADDRESS--}}
                    ...
                    <div class="col-12 collapse show" id="add-new-address-form">{{--create address form--}}
                        <div class="card">
