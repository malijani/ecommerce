        ...
        <div class="card-header">
            ...
            <div class="col-12">
                <div class="row align-items-center justify-content-start">
                    <div class="badge badge-secondary p-2 mt-1 mr-1">
            ...
            <div class="col-12 my-2">
                <div class="row align-items-center">
                    @if(!empty($article->bef))
                        <div
                            class="col-12 col-md-6 mt-2 mt-md-0 ml-auto text-right bg-light before_suggestion">
                            ...
                            >
                                <div class="row align-items-center justify-content-between ">
                                    ...
                                    <div class="col-4">
                                        <img src="{{ asset($article->bef->pic ?? 'images/fallback/article.png') }}"
                                             alt="{{ $article->bef->pic_alt  ?? $article->bef->title_en}}"
                                             id="main-image"
                        ...
                        <div
                            ...
                            >
                                <div class="row align-items-center justify-content-between ">
                                    ...
                                    <div class="col-4">
                                        <img src="{{ asset($article->af->pic ?? 'images/fallback/article.png') }}"
                                             alt="{{ $article->af->pic_alt ?? $article->bef->title_en }}"
                                             id="main-image"
                                             class="img-fluid product-image rounded suggest_img"
                                        >
                                    </div>
