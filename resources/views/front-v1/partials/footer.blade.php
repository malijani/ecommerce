<footer class="mt-5 mt-sm-3 p-4 p-sm-2 font-14">
    ...
    <div class="container-fluid">
        <div class="mt-5 bg-white p-3 rounded text-center">
            <div class="row">
                <div class="col-md-3 pt-sm-0">جدید ترین محصولات</div>
                <div class="col-md-3  pt-sm-4">جدید ترین نظرات</div>
                <div class="col-md-3  pt-sm-4">مجوز ها</div>
                <div class="col-md-3  pt-sm-4">جدید ترین مقالات</div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="mt-5 bg-dark text-lime-a100 text-center p-3 font-weight-bolder rounded">
            <div class="row">
                <div class="col-md-3 mt-sm-0">دارای مجوز وزارت صمت</div>
                <div class="col-md-3 mt-sm-3">تماس بگیرید : 9103944579(+98)</div>
                <div class="col-md-3 mt-sm-3">پردازش سفارشات ۷ روز هفته ۲۴ ساعت شبانه روز</div>
                <div class="col-md-3 mt-sm-3">ارسال به سراسر کشور</div>
            </div>
        </div>
        {{--SERVICES AND SOCIAL MEDIAS--}}
        <div class="mt-0 bg-grey-300 text-center p-4 font-16">
            <div class="row">
                <div class="col-md-3 mt-sm-0">
                    موضوع قابل نمایش
                </div>
