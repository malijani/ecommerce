...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('footer-licenses.update', $footer_license->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="title"
                                           ...
                                           minlength="2"
                                           maxlength="50"
                                           value="{{ old('title') ?? $footer_license->title }}"
                                           required
                                    >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="link"
                                           ...
                                           minlength="2"
                                           maxlength="100"
                                           value="{{ old('link') ?? $footer_license->link }}"
                                           required
                                    >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    >
                                        ...
                                        <option value="0" @if(old('status') ?? $footer_license->status == 0) selected @endif>عدم نمایش</option>
                                        <option value="1" @if(old('status') ?? $footer_license->status == 1) selected @endif>نمایش</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="col-4 mx-auto text-center">{{--IMG--}}
                                    <img src="{{asset($footer_license->image)}}"
                                         alt="نمایش تصویر نماد منتخب"
                                         class="preview img img-fluid rounded align-middle w-50"
                                         id="preview"
                                    >
                                </div>{{--./IMG--}}
                            </div>
