...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('footer-links.update', $footer_link->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="title"
                                           ...
                                           value="{{ old('title') ?? $footer_link->title }}"
                                           required
                                    >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="link"
                                           ...
                                           value="{{ old('link') ?? $footer_link->link }}"
                                           required
                                    >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    >
                                        ...
                                        <option value="0" @if(old('status')?? $footer_link->status ==0) selected @endif>عدم نمایش</option>
                                        <option value="1" @if(old('status')?? $footer_link->status ==1) selected @endif>نمایش</option>
                                    </select>
                                    ...
                                    >
                                        ...
                                        @foreach($footer_items as $item)
                                            <option value="{{ $item->id }}"
                                                    @if($item->id == old('item_id') ?? $footer_link->item_id) selected @endif
                                            >{{ $item->title }}</option>
                                        @endforeach
