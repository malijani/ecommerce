...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('favicons.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-12">{{--PREVIEW PIC + DEFAULT SELECTOR--}}
                            <div class="form-group row">
                                <div class="col-md-12 text-center">{{--IMG--}}
                                    <img src="{{asset('images/fallback/favicon.ico')}}"
                                         alt="نمایش لوگو منتخب"
                                         class="preview img  img-fluid rounded align-middle image-checkable"
                                         id="preview"
                                         name="status"
                                    >
                                </div>{{--./IMG--}}
