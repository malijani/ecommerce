...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('image-menus.update', $image_menu->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="title"
                                           ...
                                           minlength="2"
                                           maxlength="50"
                                           value="{{ old('title') ?? $image_menu->title }}"
                                           required
                                    >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="link"
                                           ...
                                           minlength="2"
                                           maxlength="100"
                                           value="{{ old('link') ?? $image_menu->link }}"
                                           required
                                    >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    >
                                        ...
                                        <option value="0" @if(old('type') ?? $image_menu->type==0) selected @endif>
                                            منو نحوه فروش و ارسال
                                        </option>
                                        <option value="1" @if(old('type') ?? $image_menu->type==1) selected @endif>
                                            منو تصویری صفحه اصلی
                                        </option>
                                        <option value="2" @if(old('type') ?? $image_menu->type==2) selected @endif>
                                            منو تصاویر بزرگ صفحه اصلی
                                        </option>
                                        <option value="3" @if(old('type') ?? $image_menu->type==3) selected @endif>
                                            منو صفحات جانبی
                                        </option>
                                        <option value="4" @if(old('type') ?? $image_menu->type==4) selected @endif >
                                            منو تصاویر بزرگ فوتر
                                        </option>
                                    </select>
                        ...
                        <div class="col-md-4">{{--STATUS--}}
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    >
                                        <option value="" disabled>انتخاب کنید...</option>
                                        <option value="0" @if(old('status') ?? $image_menu->status ==0) selected @endif>
                                            عدم نمایش
                                        </option>
                                        <option value="1" @if(old('status') ?? $image_menu->status ==1) selected @endif>
                                            نمایش
                                        </option>
                                    </select>
