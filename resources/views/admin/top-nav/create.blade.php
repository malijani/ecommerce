...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('top-navs.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">{{--SCREEN--}}
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    >
                                        <option value="" disabled>انتخاب کنید...</option>
                                        <option value="0" @if(old('screen')==0) selected @endif>صفحه نمایش کوچک</option>
                                        <option value="1" @if(old('screen')==1) selected @endif>صفحه نمایش بزرگ<option>
                                    </select>
