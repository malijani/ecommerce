...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('faqs.update', $faq->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    >
                                        ...
                                        <option value="0" @if(old('status')==0 || $faq->status == 0) selected @endif>عدم نمایش</option>
                                        <option value="1" @if(old('status')==1 || $faq->status == 1) selected @endif>نمایش</option>
                                    </select>
                        ...
                        <div class="col-md-4">{{--COLLAPSE--}}
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    >
                                        <option value="" disabled>انتخاب کنید...</option>
                                        <option value="0" @if(old('collapse')==0 || $faq->collapse == 0) selected @endif>جمع شده</option>
                                        <option value="1" @if(old('collapse')==1 || $faq->collapse == 1) selected @endif>باز شده</option>
                                    </select>
