...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('social-medias.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">{{--SIDE IMAGE--}}
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-6 text-center">{{--IMG--}}
                                    <img src="{{asset('images/fallback/social_media/side_image.png')}}"
                        ...
                        <div class="col-md-12">{{--BANNER IMAGE--}}
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-6 text-center">{{--IMG--}}
                                    <img src="{{asset('images/fallback/social_media/banner_image.png')}}"
