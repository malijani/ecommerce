...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form" action="{{ route('discount-codes.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    >
                                        ...
                                        <option value="0" @if(old('status')==0) selected @endif>غیر قابل استفاده</option>
                                        <option value="1" @if(old('status')==1) selected @endif>قابل استفاده</option>
                                    </select>
