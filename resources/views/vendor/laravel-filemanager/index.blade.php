...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('lfm-asset/bootstrap.min.css') }}">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css">
    <link rel="stylesheet" href="{{asset('lfm-asset/jquery-ui.min.css')}}">
...
<script src="{{ asset('lfm-asset/jquery-3.2.1.min.js') }}"></script>
<script src="{{ asset('lfm-asset/popper.min.js') }}"></script>
<script src="{{ asset('lfm-asset/bootstrap.min.js') }}"></script>
<script src="{{ asset('lfm-asset/jquery-ui.min.js') }}"></script>
